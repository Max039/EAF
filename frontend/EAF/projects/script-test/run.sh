...
export EVOAL_JVM_ARGUMENTS="--add-opens=de.evoal.optimisation.api/de.evoal.optimisation.api.statistics=de.evoal.eaf --add-exports=de.evoal.optimisation.api/de.evoal.optimisation.api.statistics=de.evoal.eaf"
